...
<body>
	...
	<div class="container">
		<br>
		<h3>
			<a href="showAllFlight" id="home">Go Back</a>
		</h3>
		<h1>Update Flight</h1>
		<br> <br> <br>
				...
				<table aria-describedby="update flight">
					...
					<tr>
						...
						<td><input type="datetime-local" name="DepatureDate"
							aria-label="Departure Date And Time" id="date"
							value="${flight.getDepatureDateTime()}"></td>
					</tr>
					<tr>
						<td><label for="Arrival Date And Time">Arrival Date
								And Time</label></td>
						<td><input type="datetime-local" name="ArrivalDate"
							aria-label="Arrival Date And Time" id="date"
							value="${flight.getArrivalDateTime()}"></td>
					</tr>
					<tr>
						<td><label for="Business Class Fare">Business Class
								Fare :</label></td>
						<td><input type="number" name="businessclassfare"
							placeholder="Rs. " id="businessclassfare"
							value="${flight.getBusinessClassFare()}"
							aria-label="Business Class Fare" min="600" max="200000"
					...
					<tr>
						...
						<td><input type="number" name="economicclassfare"
							placeholder="Rs. " id="economicclassfare"
							value="${flight.getEconomicClassFare()}"
							aria-label="Economic Class Fare" min="600" max="200000"
							title="must contain number only maximum Rs. 600 minimum Rs. 200000">
						</td>
					</tr>
					...
					<tr>
						...
						<td><select name="status" aria-label="flight status">
					...
					<tr>
						...
						<td><input type="number" name="businessclassseat"
							...
							min="50" max="350" aria-label="Business Class Seats Count"
					...
					<tr>
						...
						<td><input type="number" name="economicclassseat"
							...
							min="50" max="350" aria-label="Economic Class Seats Count"
							title="must contain number only maximum 50 minimum 350 number of seats"></td>
					</tr>
				</table>
