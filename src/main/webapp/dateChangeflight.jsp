  ...
  //  System.out.println("date change page "+bookingId);
	...
	session.setAttribute("oldflighteseats", eseats);
        ...
        <div class="price">
            ...
            if(flight.getBusinessClassSeat()>=bookingpackage.getNoOfPerson()) {            %>
                <input type="radio" name="price" id="Business" value="<%=flight.getEconomicClassFare()%>" required><label for="">Economic Class <span><%=flight.getEconomicClassFare() %></span></label>
               <%} } %>
            </p>
