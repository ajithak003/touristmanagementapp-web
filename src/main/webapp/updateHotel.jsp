...
<body>
	...
	<br>
	<h3>
		<a href="showAllHotel" id="home">Go Back</a>
	</h3>
				...
				<table aria-describedby="update hotel">
					...
					<tr>
						...
						<td><input type="text" name="standardprice"
							placeholder="Rs. " required id="standardprice"
							aria-label="Hotel Standard Room One Day Price"
							value="${hotel.getMidRangePrice()}" min="600" max="200000"
					...
					<tr>
						...
						<td><input type="text" name="premiumprice" id="premiumprice"
							placeholder="Rs. " value="${hotel.getPremiumPrice()}" required
							aria-label="" min="600" max="200000"
							title="must contain numbers Rs. 500 minimum Rs. 100000 only"></td>
					</tr>

					<tr>
						<td><label for="hotel status">Status :</label></td>
						<td><select name="status" aria-label="hotel status">
